                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="app_url" name="linkedin" placeholder="{{__("Linkedin url")}}" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="app_url" name="github" placeholder="{{__("Github url")}}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{__("Twitter")}}</label>
                                    <input type="app_url" name="twitter" placeholder="{{__("Twitter url")}}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{__("Website")}}</label>
                                    <input type="app_url" name="website" placeholder="{{__("Website url")}}" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
