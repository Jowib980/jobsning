    ...
    public function run()
    {
                ...
                [
                    ...
                    'val'   => '<p class="phone-num"><span>Call us </span><a href="tel:123 456 7890">123 456 7890</a></p>
                                <p class="address">329 Queensberry Street, North Melbourne VIC<br> 3051, Australia. <br>
                                    <a href="mailto:support@jobsning.com" class="email">support@jobsning.com</a>
                                </p>'
                ],
                [
                    'name'  => 'copyright',
                    'val'   => '© 2021 <a href="/">Jobsning.com</a>. All Right Reserved.'
                ],
                [
                    'name'  => 'footer_socials',
        ...
        $home_page_1 = [
            ...
            [
                ...
                'name' => 'App Download',
                'model' =>[
                    'title' => 'Get the Jobsning.com <br>Search App',
...
<h2>Contacting us</h2>
<p>If you would like to contact us to understand more about this Policy or wish to contact us concerning any matter relating to individual rights and your Personal Information, you may do so via the <a target="_blank" rel="nofollow" href="http://jobsning.com/contact">contact form</a></p>
<p>This document was last updated on October 6, 2020</p>';
        ...
        DB::table('core_settings')->insert([
                ...
                [
                    'name'  => "email_header",
                    'val'   => '<h1 class="site-title" style="text-align: center">Jobsning.com</h1>',
                ],
                [
                    'name'  => "email_footer",
                    'val'   => '<p class="" style="text-align: center">&copy; 2022 Jobsning.com. All rights reserved</p>',
                ],
                [
                ...
                [
                    ...
                    <p>Thank you for signing up with Jobsning.com! We hope you enjoy your time with us.</p>
                    <p>Regards,</p>
                    <p>Jobsning.com</p>',
                ],
                [
        ...
        DB::table('core_settings')->insert([
            ...
            [
                ...
                'val'   => "<p><span style=\"font-size: 14pt;\"><strong>Jobsning.com</strong></span></p>
                                <p>Ha Noi, Viet Nam</p>
                                <p>www.jobsning.com</p>",
            ],
        ]);
