                            ...
                            <div class="inner-box">
                                ...
                                <div class="table-footer">
                                    <?php if($user and $user_plan = $user->user_plan and $user_plan->plan_id == $plan->id): ?>
                                        ...
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <a href="<?php echo e(route('user.plan.buy',['id'=>$plan->id])); ?>" class="theme-btn btn-style-three"><?php echo e(__('Select')); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH /home/prolydnj/jobsning.com/modules/User/Views/frontend/plan/list.blade.php ENDPATH**/ ?>