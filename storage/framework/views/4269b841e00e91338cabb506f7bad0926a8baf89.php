...
<div class="inner-box">
    <div class="content">
        ...
        <?php endif; ?>
        <h4>
            <a href="<?php echo e($row->getDetailUrl()); ?>"><?php echo e($row->title); ?></a>
        </h4>
        <ul class="job-info">
...
</div><?php /**PATH C:\xampp7\htdocs\jobsning\modules/Job/Views/frontend/layouts/loop/job-item-1.blade.php ENDPATH**/ ?>