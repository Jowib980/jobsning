        ...
        <div class="default-form">
            ...
            <form method="post" action="<?php echo e(route("company.contact.store")); ?>"  class="bravo-contact-block-form">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                        <button class="theme-btn btn-style-one" type="submit" name="submit-form"><?php echo e(__('Send Message')); ?> 
...
<?php /**PATH C:\xampp\htdocs\jobsning\modules/Job/Views/frontend/layouts/details/contact.blade.php ENDPATH**/ ?>