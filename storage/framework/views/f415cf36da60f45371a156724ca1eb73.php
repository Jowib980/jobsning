...
<?php $__env->startSection('content'); ?>
    <h2 class="title-bar no-border-bottom">
        <?php echo e(__("Availability Gigs")); ?>
    ...
    <script>
        ...
        $('#items_tab').on('show.bs.tab',function (e) {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events:{
                    url:"<?php echo e(route('gig.vendor.availability.loadDates')); ?>",
                    extraParams:{
                        id:lastId,
                    }
                },
                ...
                eventClick:function (info) {
                    var form = Object.assign({},info.gig.extendedProps);
                    form.start_date = moment(info.gig.start).format('YYYY-MM-DD');
                    form.end_date = moment(info.gig.start).format('YYYY-MM-DD');
                    console.log(form);
                    formModal.show(form);
                },
                eventRender: function (info) {
                    $(info.el).find('.fc-title').html(info.gig.title);
                    $(info.el).find('.fc-content').attr("data-html","true").attr("title",info.gig.title).tooltip({ boundary: 'window' })
                }
            });
            calendar.render();
        });
        ...
        formModal = new Vue({
            ...
            methods:{
                ...
                saveForm:function () {
                    ...
                    $.ajax({
                        url:'<?php echo e(route('gig.vendor.availability.store')); ?>',
                        data:this.form,
                        dataType:'json',
                        method:'post',
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jobsning\modules\Gig\Views\frontend\user\availability.blade.php ENDPATH**/ ?>