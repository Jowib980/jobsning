...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <form action="<?php echo e(route('user.admin.role.verifyFieldsStore')); ?>" class="needs-validation" novalidate>
                    <?php echo csrf_field(); ?>
                <div class="panel">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jobsning\modules\User\Views\admin\role\verifyFieldsEdit.blade.php ENDPATH**/ ?>