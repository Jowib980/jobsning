...
<div class="header-logo flex-shrink-0">
        <?php if($logo_id): ?>
            ...
            <div class="logo-text px-4">
                <img src="<?php echo e($logo); ?>" alt="<?php echo e(setting_item("site_title")); ?>" style="width: 100%;">
            </div>
        <?php else: ?>
        <div class="logo-text">
                            ...
                            <li class="notification <?php echo e($active); ?>">
                                <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <a class="<?php echo e($class); ?>" data-id="<?php echo e($idNotification); ?>" href="<?php echo e($url); ?>" target="_blank"><?php echo $message; ?></a>
...
<?php /**PATH C:\xampp\htdocs\jobsning\modules/Layout/admin/parts/header.blade.php ENDPATH**/ ?>