...
<?php $__env->startSection('script.body'); ?>
    <script>
        $(document).on('click', '#set_paid_btn', function (e) {
            var id = $(this).data('id');
            $.ajax({
                url:superio.url+'/booking/setPaidAmount',
                data:{
                    id: id,
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jobsning\modules\Report\Views\admin\booking\index.blade.php ENDPATH**/ ?>