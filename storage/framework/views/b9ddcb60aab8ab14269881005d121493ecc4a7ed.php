...
<?php $__env->startSection('content'); ?>
    <div class="login-section">
        <div class="image-layer" style="background-image: url(<?php echo e(asset('module/superio/images/background/13.jpg')); ?>);"></div>
        <div class="outer-box">
            <!-- Login Form -->
...
<?php echo $__env->make('Layout::auth.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/prolydnj/jobsning.com/resources/views/auth/login.blade.php ENDPATH**/ ?>