    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="panel">
                    <div class="panel-title"><strong><?php echo e(__('Update Superio')); ?></strong></div>
                    <div class="panel-body">
                            ...
                            <?php if($updater_latest_version = setting_item('updater_latest_version') and version_compare(config('app.version'),$updater_latest_version,'=')): ?>
                                <p class="alert-success alert"><strong><?php echo e(__("You are using newest version of Superio: :version",['version'=>$updater_latest_version])); ?></strong></p>
                            <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jobsning\modules\Core\Views\admin\updater\index.blade.php ENDPATH**/ ?>