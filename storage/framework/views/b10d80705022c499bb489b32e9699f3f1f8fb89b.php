                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="phone_number" placeholder="<?php echo e(__("Phone Number")); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <option value="certificate"><?php echo e(__("Native")); ?></option>
                                                <option value="diploma"><?php echo e(__("Fluent")); ?></option>
                                            </select>
                                            </div>
                                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\jobsning\modules/Candidate/Views/admin/resume/form.blade.php ENDPATH**/ ?>