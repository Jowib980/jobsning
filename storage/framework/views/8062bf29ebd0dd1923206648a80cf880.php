...
<?php if($reviews->total()): ?>
    <div class="bravo-reviews">
        ...
        <div class="text-center mt30"><a class="btn btn-success" href="<?php echo e(route('user.profile.reviews',['id'=> $user->user_name ?? $user->id])); ?>"><?php echo e(__('View all reviews (:total)',['total'=>$reviews->total()])); ?></a></div>
    </div>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jobsning\modules\User\Views\frontend\profile\reviews.blade.php ENDPATH**/ ?>