    ...
    <div class="container-fluid">
        ...
        <div class="text-right">
            <div class="header-status-control">
                <a href="<?php echo e(url("/admin/module/user/verification")); ?>"><?php echo e(__("All Verification")); ?></a> -
                <a href="<?php echo e(url("/admin/module/user/verification?status=pending")); ?>"><?php echo e(__("Pending")); ?></a> -
                <a href="<?php echo e(url("/admin/module/user/verification?status=approved")); ?>"><?php echo e(__("Approved")); ?></a>
            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jobsning\modules\User\Views\admin\verification\index.blade.php ENDPATH**/ ?>