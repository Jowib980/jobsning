    ...
    <li class="notification <?php echo e($active); ?>">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <a class="<?php echo e($class); ?> p-0" data-id="<?php echo e($idNotification); ?>" href="<?php echo e($url); ?>"><?php echo $message; ?></a>
...
<?php /**PATH C:\xampp\htdocs\jobsning\modules/Core/Views/admin/notification/notification-loop-item.blade.php ENDPATH**/ ?>