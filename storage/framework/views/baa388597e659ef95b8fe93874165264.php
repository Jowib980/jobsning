                ...
                <div class="container mb-4">
                    <div class="card shadow p-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <!-- <div class="">
                                <a class="dropdown-item" href="<?php echo e(route('job.admin.applicants.changeStatus', ['status' => 'hired', 'id' => $row->id])); ?>"><button class="btn btn-info">Hired</button></a>
                                <a class="dropdown-item" href="<?php echo e(route('job.admin.applicants.changeStatus', ['status' => 'rejected', 'id' => $row->id])); ?>"><button class="btn btn-danger">Not Interested</button></a>
                            </div> -->
                        </div>
                    </div>
                </div>
