                ...
                <div class="col-order-left">
                    <div class="default-tabs style-two tabs-box">
                        <ul class="tab-buttons clearfix">
                            <li class="<?php if($tab == 'activity'): ?> active-btn <?php endif; ?>"><a href="<?php echo e(route("seller.order.activity", [ 'id' => $order->id ])); ?>"><?php echo e(__("Activity")); ?></a></li>
                            <?php if(!empty($order->requirements)): ?>
                                <li class="<?php if($tab == 'requirements'): ?> active-btn <?php endif; ?>"><a href="<?php echo e(route("seller.order.requirements", [ 'id' => $order->id ])); ?>"><?php echo e(__("Requirements")); ?></a></li>
                            <?php endif; ?>
                        </ul>
                    </div>

                    <?php if ($__env->exists("Gig::frontend.seller.order.tab." . $tab)) echo $__env->make("Gig::frontend.seller.order.tab." . $tab, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jobsning\modules\Gig\Views\frontend\seller\order\detail.blade.php ENDPATH**/ ?>