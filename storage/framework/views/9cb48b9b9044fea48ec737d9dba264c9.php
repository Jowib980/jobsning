<?php
    ...
    $delivery_count = 0;
?>
<div class="bc-order-panel <?php if($order->status == \Modules\Gig\Models\GigOrder::COMPLETED || $order->status == \Modules\Gig\Models\GigOrder::CANCELLED): ?> bc-order-completed <?php endif; ?>">
        ...
        <div class="activity-item placed-order">
            ...
            <div class="item-body">
                <div class="item-title">
                    <?php echo e(__("You placed the order")); ?> <span class="activity-time"><?php echo e(date('M d, h:i A', strtotime($order->created_at))); ?></span>
                </div>
            </div>
        </div>
                ...
                <?php switch($activity['type']):
                    case (\Modules\Gig\Models\GigOrderActivity::TYPE_REQUIREMENTS): ?>
                        <div id="activity-<?php echo e($activity->id); ?>" class="activity-item requirements">
                            ...
                            <div class="item-body">
                                <div class="item-title">
                                    <?php echo e(__("You submitted the requirements")); ?> <span class="activity-time"><?php echo e(date('M d, h:i A', strtotime($activity->created_at))); ?></span>
                                </div>
                            </div>
                        </div>
                        <?php break; ?>
                    <?php case (\Modules\Gig\Models\GigOrderActivity::TYPE_ORDER_STARTED): ?>
                        <div id="activity-<?php echo e($activity->id); ?>" class="activity-item order-started">
                            ...
                            <div class="item-body">
                                <div class="item-title">
                                    <?php echo e(__("Your order started")); ?> <span class="activity-time"><?php echo e(date('M d, h:i A', strtotime($activity->created_at))); ?></span>
                                </div>
                            </div>
                        </div>
                        <?php break; ?>
                    <?php case (\Modules\Gig\Models\GigOrderActivity::TYPE_DELIVERY_DATE): ?>
                        <div id="activity-<?php echo e($activity->id); ?>" class="activity-item delivery-date">
                            ...
                            <div class="item-body">
                                <div class="item-title">
                                    <?php echo e(__("Your delivery date was updated to")); ?> <?php echo e(date('M d', strtotime($order->delivery_date))); ?><span class="activity-time"><?php echo e(date('M d, h:i A', strtotime($activity->created_at))); ?></span>
                                </div>
                            </div>
                        </div>
                        <?php break; ?>
                    <?php case (\Modules\Gig\Models\GigOrderActivity::TYPE_DELIVERED): ?>
                        ...
                        <div id="activity-<?php echo e($activity->id); ?>" class="activity-item delivered">
                            ...
                            <div class="item-body">
                                <div class="item-title">
                                    <a href="#"><?php echo e($activity->user->getDisplayName()); ?></a> <?php echo e(__("delivered your order")); ?>
                    ...
                    <?php case (\Modules\Gig\Models\GigOrderActivity::TYPE_REVISION): ?>
                        <div id="activity-<?php echo e($activity->id); ?>" class="activity-item revision">
                            ...
                            <div class="item-body">
                                <div class="item-title">
                                     <?php echo e(__("Your requested a revision")); ?>
                ...
                <div class="item-body">
                    <div class="item-title">
                        <?php if($order->status == 'cancelled'): ?>
                            <?php echo e(__("Your order is cancel.")); ?>

                        <?php else: ?>
                            <?php echo e(__("Your order is complete.")); ?>
...
<?php if($order->status == \Modules\Gig\Models\GigOrder::DELIVERED): ?>
    <div class="button-group text-center mt-4">
        <a class="theme-btn btn-style-one bg-blue mr-3 accept-order"
           data-confirm="<?php echo e(__("Do you want to accept the order?")); ?>"
           href="<?php echo e(route('buyer.accept_order', ['id' => $order->id])); ?>"><?php echo e(__("Accept")); ?></a>
        <?php if(!$order->orderExpired()): ?>
            <a class="theme-btn btn-style-one bg-blue bc-request-vision" href="#"><?php echo e(__("Request A Revision")); ?></a>
            <?php echo $__env->make('Gig::frontend.elements.revision-popup', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
    </div>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\jobsning\modules\Gig\Views\frontend\buyer\order\tab\activity.blade.php ENDPATH**/ ?>