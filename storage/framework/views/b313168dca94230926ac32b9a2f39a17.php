                ...
                <select name="languages[]" multiple="multiple" id="languages" class="form-control select2">
                    <?php $__currentLoopData = $allLanguages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($language->id); ?>" 
                            <?php if(in_array($language->id, $selectedLanguages)): ?> selected <?php endif; ?>>
...
<?php $__env->stopSection(); ?><?php /**PATH C:\xampp\htdocs\jobsning\modules\Candidate\Views\admin\candidate\form.blade.php ENDPATH**/ ?>