                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-link btn-sm p-0 m-0" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                            ...
                                                            <?php endif; ?>
                                                        <form method="post" action="<?php echo e(url('admin/module/job/applicant)')); ?>">
                                                               <?php echo e(csrf_field()); ?>
                                                    ...
                                                    <div class="modal fade" id="interview-modal-<?php echo e($row->id); ?>">
                                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                                            <div class="modal-content">

                                                                <div class="modal-header">
                                                                    <h4 class="modal-title"><?php echo e(__("Setup Interview")); ?></h4>
                                                                </div>
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="info-form">
                                                                        <div class="applied-list">
                                                                            ...
                                                                            <div class="applied-item">
                                                                                <div class="label"><?php echo e(__("Round:")); ?></div>
                                                                                <div class="val">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\jobsning\modules/Job/Views/admin/job/all-applicants.blade.php ENDPATH**/ ?>